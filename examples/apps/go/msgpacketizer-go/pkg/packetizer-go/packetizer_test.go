...
func TestPacketizer(t *testing.T) {
	...
	t.Run("simple", func(t *testing.T) {
		// encode
		encoded := Encode(0x01, simple_packed)
		...
		if reflect.DeepEqual(decoded.Data, simple_packed) != true {
			t.Errorf("data mismatch: %s and %s", ToHex(decoded.Data), ToHex(simple_packed))
		}
	})
	t.Run("arr", func(t *testing.T) {
		// encode
		encoded := Encode(0x11, arr_packed)
		...
		if decoded.Index != 0x11 {
			t.Errorf("index mismatch: %d", decoded.Index)
		}
		if reflect.DeepEqual(decoded.Data, arr_packed) != true {
			t.Errorf("data mismatch: %s", decoded.Data)
		}
	})
	t.Run("map", func(t *testing.T) {
		// encode
		encoded := Encode(0x21, mp_packed)
		...
		if reflect.DeepEqual(decoded.Data, mp_packed) != true {
			t.Errorf("data mismatch: %s", decoded.Data)
		}
	})
	t.Run("custom", func(t *testing.T) {
		// encode
		encoded := Encode(0x31, custom_packed)
		...
		if reflect.DeepEqual(decoded.Data, custom_packed) != true {
			t.Errorf("data mismatch: %s", decoded.Data)
		}
	})
}
