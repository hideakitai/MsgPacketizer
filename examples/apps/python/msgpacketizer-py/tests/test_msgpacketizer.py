...
def test_encode():
    encoded = msgpacketizer.encode(0x01, simple)
    assert encoded == simple_encoded

    encoded = msgpacketizer.encode(0x11, arr)
    assert encoded == arr_encoded

    encoded = msgpacketizer.encode(0x21, mp)
    assert encoded == mp_encoded

    encoded = msgpacketizer.encode(0x31, custom)
